...
<script src="https://api-maps.yandex.ru/v3/?apikey=5e353c3e-e42e-49cb-becf-b093bebcbd53&lang=ru_RU" type="text/javascript"></script> <!-- Создаём контейнер для карты -->
...
<script type="text/javascript">
	...
	// 		`
	// 			});
	// 			console.log(object_<?= $arSection['ID'] ?>)
