                ...
                <?php if (!empty($arItem['PROPERTIES']['BUTTON_TEXT']['VALUE'])) : ?>
                    <div class="b-list-buttons">
                        ...
                        <?php } else { ?>
                            ...
                            <?php } else { ?>
                                <button data-toggle="modal" data-target="#b-zapis-form" data-form-param="<?= $arItem['PROPERTIES']['MODAL_TITLE']['~VALUE'] ?>" data-form-subtitle="<?= $arItem['PROPERTIES']['MODAL_SUBTITLE']['~VALUE'] ?>" class="btn btn-ajax b-btn b-btn-primary"><?= $arItem['PROPERTIES']['BUTTON_TEXT']['~VALUE'] ?></button>
                            <?php } ?>
                        <?php } ?>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="b-service-modal-inner">
                                ...
                                <?php endif; ?>
                                <div class="name btn-ajax" data-toggle="modal" data-target="#b-personal-detail-modal-<?= $arItem['ID'] ?>">
                                    <?= $arItem['NAME']; ?>
                                </div>
                                <?php if ($arItem['PROPERTIES']['PHONE']['~VALUE']) : ?>
                                    <div class="tel">
                                ...
                                <?php if (!empty($arItem['PROPERTIES']['BUTTON_TEXT']['VALUE'])) : ?>
                                    <div class="b-list-buttons">
                                        ...
                                        <?php } else { ?>
                                            <button data-toggle="modal" data-target="#b-zapis-form" data-form-title="<?= $arItem['NAME']; ?>" class="btn btn-ajax b-btn b-btn-primary"><?= $arItem['PROPERTIES']['BUTTON_TEXT']['~VALUE'] ?></button>
                                        <?php } ?>
                                    </div>
                                <?php endif; ?>
                            </div>
