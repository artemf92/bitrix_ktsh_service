            ...
            <div class="swiper-slide <?= $text_center ?> <?= $video ? 'b-slide-with-video' : '' ?>">
                <?php if ($video) { ?>
                    <div class="b-slider-video-wrap">
                        <video class="b-slide-video d-none d-sm-block" style="outline: none !important;" width="100%" height="100%" poster="<?= $arItem['BACKGROUND_IMAGE'] ?>" autoplay="autoplay" loop="loop" muted="" playsinline="">
                            ...
                            <?php if ($show_button_one || $show_button_two) { ?>
                                <div class="b-slider-buttons">
                                    <?php if ($show_button_one && !$show_button_one_link) : ?>
                                        <button data-toggle="modal" data-target="#b-zapis-form" data-form-title="<?= $arItem['NAME'] ?>" class="btn btn-ajax b-btn b-btn-primary"><?= $arItem['PROPERTIES']['BUTTON_ONE_TEXT']['VALUE'] ?></button>
                                    <?php endif; ?>
                                    <?php if ($show_button_one && $show_button_one_link) : ?>
                                    ...
                                    <?php if ($show_button_two && !$show_button_two_link) : ?>
                                        <button data-toggle="modal" data-target="#b-zapis-form" data-form-title="<?= $arItem['NAME'] ?>" class="btn btn-ajax b-btn b-btn-primary"><?= $arItem['PROPERTIES']['BUTTON_TWO_TEXT']['VALUE'] ?></button>
                                    <?php endif; ?>
                                    <?php if ($show_button_two && $show_button_two_link) : ?>
