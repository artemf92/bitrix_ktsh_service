...
if (0 == count($arResult['ITEMS'])) {
    echo '<button data-toggle="modal" data-target="#b-zapis-form" data-form-title="Электронное обращение" class="b-btn btn-ajax b-btn-primary btn d-block m-auto">Электронное обращение</button>';
}
?>
                        ...
                        <?php if (!empty($arItem['PROPERTIES']['BUTTON_TEXT']['VALUE'])) : ?>
                            <div class="b-list-buttons">
                                ...
                                <?php } else { ?>
                                    ...
                                    <?php } else { ?>
                                        <button data-toggle="modal" data-target="#b-zapis-form" class="btn btn-ajax b-btn b-btn-primary"><?= $arItem['PROPERTIES']['BUTTON_TEXT']['~VALUE'] ?></button>
                                    <?php } ?>
                                <?php } ?>
                            </div>
                        <?php endif; ?>
