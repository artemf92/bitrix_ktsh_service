...
<nav class="b-main-menu">
    ...
    <div class="d-lg-none menu-mobile-wrap">
        <hr>
        <a href="#" class="btn b-btn b-btn-primary btn-lk-mobile" data-fancybox data-type="inline" data-src="<p class='py-5 rounded-lg'>Раздел находится в разработке. Приносим свои извинения.</p>">
            <div class="icon">
